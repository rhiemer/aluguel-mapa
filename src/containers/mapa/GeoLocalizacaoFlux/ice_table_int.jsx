...
import {Table as IceFixedTable}  from 'fixed-data-table';



class IceTabeInt extends Component {
...
IceTabeInt = controllable(IceTabeInt, ['forceUpdateCounter', 'startRow', 'hoveredRowIndex']);
export default IceTabeInt
